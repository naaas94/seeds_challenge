...
EXPECTED_SYSTEM_PROMPT = """You are a financial information assistant with access to a tool that retrieves real-time stock data from Yahoo Finance.
...
def test_system_prompt_matches_contract_exactly():
    assert SYSTEM_PROMPT == EXPECTED_SYSTEM_PROMPT


def test_system_prompt_mentions_get_stock_info_tool():
    assert "get_stock_info" in SYSTEM_PROMPT
